...
<div class="panel panel-inverse">
    ...
    <div class="panel-heading">
        <h4 class="panel-title">Detalle Permiso {{$data['name']}}</h4>
    ...
    <div class="panel-body">
        <form action="{{ route('permissions.update', $data['id']) }}" method="POST" accept-charset="utf-8" id="edit_permission_form" class="mb-0 needs-validation" enctype="multipart/form-data" role="form" >
            {{ method_field('PATCH') }}
            <div class="card-body">
